<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Checkout.aspx.cs" Inherits="WebApplication2.Chechout" %>
        	...
        	<div class="container">
        		<div class="row">
        			<div class="col-md-12">
        				...
        				<div class="panel-group custom-accordion" id="Comprar">
							<div class="panel">
								<div class="accordion-header">
									<div class="accordion-title">1 Step: <span>Comprar Option</span></div><!-- End .accordion-title -->
									<a class="accordion-btn opened"  data-toggle="collapse" data-target="#checkout_option"></a>
								</div><!-- End .accordion-header -->
								
								<div id="checkout_option" class="collapse in">
								  <div class="panel-body">
								   <div class="row">
								   	
								   	<div class="col-md-6 col-sm-6 col-xs-12">					   		
								   		<h2 class="checkout_title">New Customer</h2>
								   	...
								   	<p>By creating an account with our store, you will be able to move through the Comprar process faster, store multiple shipping addresses, view and track your orders in your account and more.</p>
									<div class="md-margin"></div>
								   	
								   	</div><!-- End .col-md-6 -->
								   
								   	<div class="col-md-6 col-sm-6 col-xs-12">					   		
								   		<h2 class="checkout_title">Registered Customers</h2>
								  ...
								  <div class="panel-body">
								   <div class="row">
								   	<div class="col-md-6 col-sm-6 col-xs-12">
								   		...
								   		<h2 class="checkout_title">Your personal details</h2>
								   		<div class="input-group">
									...
									<div class="input-group xlg-margin">
								   	...
								   	<div class="col-md-6 col-sm-6 col-xs-12">
									<h2 class="checkout_title">Your Address</h2>
        					...
        					<div class="panel">
								...
								<div class="table-responsive">
									...
									<tr>
										...
										<tr>
											<td class="checkout_table-title" colspan="4">Subtotal:</td>
											<td class="checkout_table-price">$399.44</td>
										</tr>
										<tr>

											<td class="checkout_table-title" colspan="4">Shipping:</td>
											<td class="checkout_table-price">$6.00</td>
										</tr>
										<tr>

											<td class="checkout_table-title" colspan="4">Tax(0%):</td>
											<td class="checkout_table-price">$0.00</td>
										</tr>
										
									</tbody>
									 <tfoot>
										<tr>
											<td class="checkout_total-title" colspan="4"><strong>TOTAL:</strong></td>
											<td class="checkout_total-price cart-total"><strong>$434.50</strong></td>
										</tr>
									</tfoot>
								  </table>
								  ...
								  <div class="text-right">
								  	  <asp:Button ID="Button1" runat="server" CssClass="btn btn-custom-2" Text="Confirmar Orden" />
